...
public class GCYSUnknownCompositionMaterials {
    ...
    public static void init() {
        ...
        RichNitrogenMixture = new Material.Builder(18013, gregtechId("rich_nitrogen_mixture")).gas(new FluidBuilder()).color(0x6891D8).build();
        ...
        SteamCrackedSodioIndene = new Material.Builder(18022, gregtechId("steam_cracked_sodio_indene")).liquid(new FluidBuilder().temperature(1850)).color(0x1C1A29).build();

        MolybdenumFlue = new Material.Builder(18023, gregtechId("molybdenum_flue")).gas(new FluidBuilder()).color(0x39194A).build();

        TraceRheniumFlue = new Material.Builder(18024, gregtechId("trace_rhenium_flue")).gas(new FluidBuilder()).color(0x96D6D5).build();

        FracturingFluid = new Material.Builder(18025, gregtechId("fracturing_fluid")).fluid().color(0x96D6D5).build();

        BedrockSmoke = new Material.Builder(18026, gregtechId("bedrock_smoke")).gas(new FluidBuilder()).color(0x525252).build();
        ...
        HeavyBedrockSmoke = new Material.Builder(18031, gregtechId("heavy_bedrock_smoke")).gas(new FluidBuilder()).color(0x242222).build();

        MediumBedrockSmoke = new Material.Builder(18032, gregtechId("medium_bedrock_smoke")).gas(new FluidBuilder()).color(0x2E2C2C).build();

            LightBedrockSmoke = new Material.Builder(18033, gregtechId("light_bedrock_smoke")).gas(new FluidBuilder()).color(0x363333).build();

        UltralightBedrockSmoke = new Material.Builder(18034, gregtechId("ultralight_bedrock_smoke")).gas(new FluidBuilder()).color(0x403D3D).build();

        HeavyTaraniumGas = new Material.Builder(18035, gregtechId("heavy_taranium_gas")).gas(new FluidBuilder()).color(0x262626).build();

        MediumTaraniumGas = new Material.Builder(18036, gregtechId("medium_taranium_gas")).gas(new FluidBuilder()).color(0x313131).build();

        LightTaraniumGas = new Material.Builder(18037, gregtechId("light_taranium_gas")).gas(new FluidBuilder()).color(0x404040).build();

        BedrockGas = new Material.Builder(18038, gregtechId("bedrock_gas")).gas(new FluidBuilder()).color(0x575757).build();
        ...
        HeavyEnrichedBedrockSmoke = new Material.Builder(18044, gregtechId("heavy_enriched_bedrock_smoke")).gas(new FluidBuilder()).color(0x1A2222).build();

        MediumEnrichedBedrockSmoke = new Material.Builder(18045, gregtechId("medium_enriched_bedrock_smoke")).gas(new FluidBuilder()).color(0x1E2C2C).build();

        LightEnrichedBedrockSmoke = new Material.Builder(18046, gregtechId("light_enriched_bedrock_smoke")).gas(new FluidBuilder()).color(0x163333).build();

        HeavyEnrichedTaraniumGas = new Material.Builder(18047, gregtechId("heavy_enriched_taranium_gas")).gas(new FluidBuilder()).color(0x1F2626).build();

        MediumEnrichedTaraniumGas = new Material.Builder(18048, gregtechId("medium_enriched_taranium_gas")).gas(new FluidBuilder()).color(0x1F3131).build();

        LightEnrichedTaraniumGas = new Material.Builder(18049, gregtechId("light_enriched_taranium_gas")).gas(new FluidBuilder()).color(0x1F4040).build();
